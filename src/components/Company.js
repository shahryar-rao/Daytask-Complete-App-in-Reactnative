...
export default function CompanyInfo({ navigation }) {
    ...
    const handleSubmit = async () => {
        ...
        if (fieldsValid) {
            setLoading(true);
            try {
                const companyDocRef = doc(collection(database, 'companies'));
                const companyData = {
                ...
                const userDocRef = doc(database, 'users', currentUser.uid);
                await setDoc(userDocRef, { companyId: companyDocRef.id }, { merge: true });
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <TouchableOpacity style={styles.button} onPress={handleSubmit}>
                    <Text style={styles.buttontext}>Insert Details</Text>
                </TouchableOpacity>
